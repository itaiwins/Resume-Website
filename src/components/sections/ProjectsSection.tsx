...
const PROJECTS = [
  ...
  },
  {
    ...
    codename: 'MCP-1',
    status: 'LIVE',
    description: 'Open security scanner for the MCP (Model Context Protocol) ecosystem. Analyzes MCP servers for vulnerabilities including prompt injection, data exfiltration, and excessive permissions. Features a public registry of 260+ scanned servers, automated vulnerability detection, and trust scores to help developers ship safer AI tool integrations.',
    specs: [
      { label: 'SERVERS', value: '260+' },
      { label: 'VULNS FOUND', value: '1,200+' },
      { label: 'SCANS', value: '490+' },
    ],
    tech: ['Next.js', 'Hono', 'PostgreSQL', 'Redis', 'AI/LLMs'],
    links: { github: 'https://github.com/itaiwins/mcp', live: 'https://mcpsafe.org' },
    iconType: 'signal',
    isPrivate: false,
  },
  {
  ...
  },
  {
    ...
    codename: 'MEX-1',
    status: 'LIVE',
    description: 'AI-powered software agency that builds custom chatbot solutions for businesses. Features an automated lead generation engine, multi-vertical demo portfolio, and cold outreach system. Live demos span restaurants, healthcare, real estate, e-commerce, home services, and SaaS — each with a fully functional AI assistant tailored to the vertical.',
    specs: [
      { label: 'VERTICALS', value: '6' },
      { label: 'DEMOS', value: 'Live' },
      { label: 'OUTREACH', value: 'Auto' },
    ],
    tech: ['Next.js', 'Railway', 'AI/LLMs', 'Email APIs', 'Vercel'],
    links: { live: 'https://mexant.com' },
    iconType: 'dashboard',
    isPrivate: false,
  },
];
